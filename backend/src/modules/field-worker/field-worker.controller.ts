...
class FieldWorkerController {
  async getAssignedJobs(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
    try {
      const result = await fieldWorkerService.getAssignedJobs(req.user!, req.query);
  ...
  async getJobDetails(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  async uploadPhotos(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const job = await fieldWorkerService.uploadPhotos(req.user!, id, photoType, images);
