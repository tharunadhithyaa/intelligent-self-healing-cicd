...
router.get('/stats', officerController.getDashboardStats.bind(officerController));
router.get('/dept-stats', officerController.getDepartmentStats.bind(officerController));
router.get('/complaints', officerController.getComplaints.bind(officerController));
router.get('/complaints/:id', officerController.getComplaintDetails.bind(officerController));
router.put(
...
router.get('/workers', officerController.getAvailableWorkers.bind(officerController));
