      ...
      <div class="stepper">
        <div class="stepper__header">
          @for (step of steps; track step.num) {
            <div class="stepper__step" [class.stepper__step--active]="currentStep() === step.num" [class.stepper__step--completed]="currentStep() > step.num">
        ...
        <div class="stepper__content">
            ...
            <form [formGroup]="infoForm" class="form-step animate-fade-in-up">
              ...
              <div class="form-grid">
                <mat-form-field appearance="outline" class="col-12">
                  ...
                  <input matInput formControlName="title" placeholder="Briefly summarize the issue (e.g. Large pothole near Main Street)" />
                  <mat-icon matPrefix>edit</mat-icon>
                  @if (infoForm.get('title')?.hasError('required') && infoForm.get('title')?.touched) {
                    <mat-error>Title is required</mat-error>
                  }
                  @if (infoForm.get('title')?.hasError('minlength') && infoForm.get('title')?.touched) {
                ...
                <mat-form-field appearance="outline" class="col-12">
                  ...
                  <textarea matInput formControlName="description" rows="4" placeholder="Explain the problem in detail so officers can address it..."></textarea>
                  <mat-icon matPrefix>description</mat-icon>
                  @if (infoForm.get('description')?.hasError('required') && infoForm.get('description')?.touched) {
                    <mat-error>Description is required</mat-error>
                  }
                  @if (infoForm.get('description')?.hasError('minlength') && infoForm.get('description')?.touched) {
                ...
                <mat-form-field appearance="outline" class="col-6">
                  ...
                  @if (infoForm.get('category')?.hasError('required') && infoForm.get('category')?.touched) {
                ...
                <mat-form-field appearance="outline" class="col-6">
                  ...
                  <input matInput formControlName="address" placeholder="Street, landmark, neighborhood..." />
                  <mat-icon matPrefix>location_on</mat-icon>
                  @if (infoForm.get('address')?.hasError('required') && infoForm.get('address')?.touched) {
              ...
              <div class="form-step__actions">
                <button mat-flat-button color="primary" (click)="goToStep2()" [disabled]="infoForm.invalid">
          ...
          @if (currentStep() === 2) {
            <div class="form-step animate-fade-in-up">
              ...
              <p class="form-step__subtitle">Our integrated AI has reviewed the complaint draft. You can confirm or modify the suggestions below.</p>
                ...
                <div class="ai-box">
                  ...
                  <div class="ai-box__score">
                    ...
                    <div class="ai-box__metrics">
                      <div class="ai-badge category">
                        <mat-icon>label</mat-icon> Classified Category: <strong>{{ aiAnalysis()?.category }}</strong>
                      </div>
                      <div class="ai-badge priority" [class]="aiAnalysis()?.priority">
                        <mat-icon>priority_high</mat-icon> Predicted Priority: <strong>{{ aiAnalysis()?.priority | uppercase }}</strong>
                      </div>
                    </div>
                  </div>
                  ...
                  @if (aiAnalysis()?.duplicateDetected) {
                    ...
                    <div class="ai-success-card">
                      ...
                      <p>Duplicate Check: No matching reports registered nearby in the last 72 hours. This is a unique issue!</p>
                    </div>
                  }
                  ...
                  <div class="ai-card">
                    ...
                    <div class="ai-card__body">
                      ...
                      <p><strong>{{ aiAnalysis()?.department }}</strong></p>
                    </div>
                  </div>
                  ...
                  <div class="ai-card">
                    ...
                    <div class="ai-card__body">
                      ...
                      <p class="summary-text"><em>"{{ aiAnalysis()?.summary }}"</em></p>
                    </div>
                  </div>
                  ...
                  <div class="override-category">
                    ...
                    <mat-form-field appearance="outline" class="col-6">
                      ...
                      <mat-select [value]="confirmedCategory()" (selectionChange)="updateConfirmedCategory($event.value)">
                        @for (cat of categories; track cat) {
                          <mat-option [value]="cat">{{ cat }}</mat-option>
                        }
                      </mat-select>
          ...
          @if (currentStep() === 3) {
            <div class="form-step animate-fade-in-up">
              ...
              <p class="form-step__subtitle">Add visual context to help field officers locate and identify the issue. (Max 2MB per image, JPG/PNG formats supported).</p>

              <div class="upload-zone" (click)="fileInput.click()">
                <input #fileInput type="file" multiple accept="image/png, image/jpeg, image/jpg" style="display:none" (change)="onFileSelected($event)" />
                  ...
                  @for (img of uploadedImages(); track img.fileName; let idx = $index) {
                    <div class="image-tile">
                      ...
                      <div class="image-tile__overlay">
                        ...
                        <button class="remove-btn" (click)="removeImage(idx)" aria-label="Remove image">
          ...
          @if (currentStep() === 4) {
            <div class="form-step animate-fade-in-up">
              ...
              <p class="form-step__subtitle">Please verify that all detailed information and coordinates are correct before finalizing submission.</p>
              ...
              <div class="review-box">
                ...
                <div class="review-box__section">
                  ...
                  <p><strong>Priority Level:</strong> <span class="priority-text" [class]="aiAnalysis()?.priority">{{ aiAnalysis()?.priority | uppercase }}</span></p>
                </div>
              ...
              <div class="form-step__actions">
                ...
                <button mat-flat-button color="primary" (click)="submit()" [disabled]="submitting()">
                  @if (submitting()) {
                    ...
                    <span>Submit Complaint <mat-icon style="display: inline-block; vertical-align: middle; margin-left: 4px; font-size: 18px; width: 18px; height: 18px;">check_circle</mat-icon></span>
                  }
                </button>
              </div>
            </div>
  ...
  styles: [`
    ...
    .ai-badge {
      ...
      &.priority {
        ...
        &.low strong { background: $primary-light; color: $primary-dark; }
        &.medium strong { background: $warning-light; color: $warning; }
        &.high strong { background: #FEE2E2; color: $danger; }
        &.critical strong { background: #7F1D1D; color: $text-inverse; }
      }
    }
    ...
    .ai-warning-card {
      ...
      h4 { font-size: $font-size-sm; font-weight: $font-weight-bold; margin-bottom: 2px; }
      p { font-size: $font-size-xs; margin: 0; }
    }
...
export class ComplaintSubmitComponent {
  ...
  submit(): void {
    ...
    this.complaintsService.submitComplaint(payload).subscribe({
      ...
      error: (err) => {
        this.submitting.set(false);
        this.notification.error(err.error?.message || 'Failed to submit complaint. Please check your data.');
      }
    });
  }
}
