...
@Component({
  ...
  template: `
    <div class="audit-logs-container animate-fade-in-up">
      <app-page-header title="System Audit Ledger" subtitle="Immutable control logs documenting administrator actions, logins, and permission adjustments."></app-page-header>
      ...
      <mat-card class="filter-card">
        <mat-card-content class="filter-grid">
          <mat-form-field appearance="outline" class="filter-item">
            ...
            <input matInput [(ngModel)]="searchQuery" (input)="onFilterChange()" placeholder="Search by email, action...">
                  ...
                  <tr class="ledger-row">
                    ...
                    <td>
                      <div class="actor-info">
                        ...
                        <span class="role-badge" [ngClass]="log.actorRole">{{ log.actorRole || 'ANONYMOUS' }}</span>
                      </div>
                    </td>
                    <td>
                    ...
                    <td>
                      @if (log.target) {
                        <span class="target-badge">
                          <strong>{{ log.target }}</strong>: {{ log.targetId?.substring(18) }}..
                        </span>
                      } @else {
                    ...
                    <td>
                      @if (log.details) {
                        <button mat-stroked-button class="btn-meta" (click)="toggleDetails(log._id)">
                      ...
                      <td colspan="5">
                        <div class="expanded-box">
                          ...
                          <div class="device-info">
                            ...
                            <span><strong>Client Agent:</strong> {{ log.userAgent || 'Unknown' }}</span>
                          </div>
                        </div>
                      </td>
                    </tr>
  ...
  styles: [`
    ...
    .action-tag {
      ...
      color: var(--text-primary);
      &.user_deactivated, &.user_locked, &.login_failed {
        background: rgba(244, 67, 54, 0.1);
        color: var(--warn-color);
      }
      &.user_activated, &.login_success {
        background: rgba(76, 175, 80, 0.1);
        color: #4caf50;
      }
      &.department_created, &.officer_assigned_to_department {
