            ...
            steps {
                ...
                script {
                    ...
                    if (isUnix()) {
                        ...
                        bat "set HTTP2_DISABLE=true && set GODEBUG=http2client=0 && trivy fs --cache-dir \"%WORKSPACE%\\.trivy-cache\" --download-db-only --db-repository \"mirror.gcr.io/aquasec/trivy-db:2,ghcr.io/aquasecurity/trivy-db:2\" ."
                    }
